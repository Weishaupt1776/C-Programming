 ...
 * Brian W. Kernighan and Dennis M. Ritchie. Modify the sort program
 * to handle a -r flag, which indicates sorting in reverse (decreasing)
...
int main(int argc, char *argv[])
{
	...
	setflags(argc,argv); /* sets appropriate flags for program */
...
void setflags(int argc, char *argv[])
{
	...
	else if (argc == 2)
	{
		if (strcmp(argv[1], "-n") == 0)
			...
			printf("error: invalid flags at command-line\n");
	...
	else if (argc == 3)
	{
		...
		if (strcmp(argv[1], "-r") == 0)		
			reverse = 1;
		if (strcmp(argv[1], "-nr") == 0 || strcmp(argv[1], "-rn") == 0)		
			numeric = reverse = 1;
		if (strcmp(argv[2], "-n") == 0)		
			numeric = 1;
		if (strcmp(argv[2], "-r") == 0)		
			reverse = 1;
		if (strcmp(argv[2], "-nr") == 0 || strcmp(argv[2], "-rn") == 0)		
			numeric = reverse = 1;
		else
			printf("error: invalid flags at command-line\n");
	}
